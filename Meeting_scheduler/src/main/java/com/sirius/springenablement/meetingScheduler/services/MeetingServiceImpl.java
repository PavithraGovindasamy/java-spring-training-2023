...
public class MeetingServiceImpl implements MeetingService {
    ...
    @Autowired
    private com.sirius.springenablement.meetingScheduler.services.interfaces.TeamService teamService;


    @Autowired
    private com.sirius.springenablement.meetingScheduler.services.interfaces.EmployeeService employeeService;
