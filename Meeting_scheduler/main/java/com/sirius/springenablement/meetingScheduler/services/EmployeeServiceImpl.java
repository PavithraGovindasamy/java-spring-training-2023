...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee save(Employee employee) {
        try {
            ...
            throw new CustomException("Failed to save employee", e);
        }
    }
    ...
    public Optional<Employee> findById(int employeeId) {
        try {
            ...
            throw new CustomException("Failed to fetch employee by ID", e);
        }
    }
    ...
    public void deleteById(int employeeId) {
        try {
            ...
            throw new CustomException("Failed to delete employee by ID", e);
        }
    }
    ...
    public List<Employee> findAll() {
        try {
            ...
            throw new CustomException("Failed to fetch all employees", e);
        }
    }
}
