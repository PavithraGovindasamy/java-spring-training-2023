...
import com.sirius.springenablement.meetingScheduler.dto.TeamsResponseDto;
...
import com.sirius.springenablement.meetingScheduler.services.TeamService;
...
public class TeamController {
    ...
    public ResponseEntity<MeetingBookingResponseDto> addEmployeeToTeam(@RequestBody AddEmployeeToTeamRequest request) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new CustomException("Failed to add employee to team");
        }
    }
    ...
    public ResponseEntity<MeetingBookingResponseDto> addTeams(@RequestBody Teams teams) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new CustomException("Failed to add team");
        }
    }
    ...
    public ResponseEntity<MeetingBookingResponseDto> updateTeams(@RequestBody Teams teams) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new CustomException("Failed to update team");
        }
    }
    ...
    public ResponseEntity<MeetingBookingResponseDto> deleteTeams(@PathVariable int teamId) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new CustomException("Failed to delete team");
        }
    }
}
