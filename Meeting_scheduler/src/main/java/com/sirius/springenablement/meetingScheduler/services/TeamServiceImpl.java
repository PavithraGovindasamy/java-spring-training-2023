...
public class TeamServiceImpl implements  TeamService{
    ...
    public Teams save(Teams teams) {
        try {
            ...
            throw new com.sirius.springenablement.meetingScheduler.exception.InvalidException("Failed to save team", e);
        }
    }
    ...
    public Optional<Teams> findById(int teamId) {
        try {
            ...
            throw new com.sirius.springenablement.meetingScheduler.exception.InvalidException("Failed to fetch team by ID", e);
        }
    }
    ...
    public void deleteById(int teamId) {
        try {
            ...
            throw new com.sirius.springenablement.meetingScheduler.exception.InvalidException("Failed to delete team by ID", e);
        }
    }
    ...
    public void addEmployeeToTeam(int employeeId, int teamId) {
        try {
            ...
            throw new com.sirius.springenablement.meetingScheduler.exception.InvalidException("Failed to add employee to team", e);
        }
    }
}
